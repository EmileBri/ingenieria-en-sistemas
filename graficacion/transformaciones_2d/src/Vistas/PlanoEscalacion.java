...
public class PlanoEscalacion extends JPanel {
    ...
    Color escalacion = new Color(0, 102, 153);
    ...
    public void paintComponent(Graphics g) {
        // Color c = new Color(255,255,255); //color rayas del plano
        int x = -14;
    ...
    public void dibujarLineas(Graphics g) {
        g.setColor(Color.gray); //linea al unir figura
        ...
        for (int i = 0; i < 5; i++) {
            ...
            g.drawLine(this.setXPixel(this.vectorPuntos[0][i]), this.setYPixel(this.vectorPuntos[1][i]),
                    this.setXPixel(this.vPuntosEscalacion[0][i]), this.setYPixel(this.vPuntosEscalacion[1][i]));
        }
