...
public class Rotacion_Generica extends JPanel {

    int ejeXx1, ejeXx2, ejeXy;
    int ejeYx1, ejeYy1, ejeYy2;
    public int vectorPuntos[][] = new int[2][5];
    public double angulos[] = new double[8];
    public double radios[] = new double[8];
    ...
    Color rotacion = new Color(255, 0, 204);
    ...
    public void setTamaño(Vista_Rotacion v) {
    ...
    public void dibujarFigura(Graphics g, Color c) {
        ...
        g.fillOval(setXPixel(-7) - 4, setYPixel(-1) - 4, 8, 8);//P1
        g.fillOval(setXPixel(-7) - 4, setYPixel(-3) - 4, 8, 8);//P2
        g.fillOval(setXPixel(-5) - 4, setYPixel(-3) - 4, 8, 8);//P3
        g.fillOval(setXPixel(-5) - 4, setYPixel(-1) - 4, 8, 8);//P4
        g.fillOval(setXPixel(-5) - 4, setYPixel(-5) - 4, 8, 8);//P5

        g.drawLine(setXPixel(-7), setYPixel(-1), setXPixel(-7), setYPixel(-3));
        g.drawLine(setXPixel(-7), setYPixel(-3), setXPixel(-5), setYPixel(-3));
        g.drawLine(setXPixel(-5), setYPixel(-3), setXPixel(-5), setYPixel(-1));
        g.drawLine(setXPixel(-5), setYPixel(-1), setXPixel(-5), setYPixel(-5));
    ...
    public void dibujarFigRotada(Graphics g, double v[][], Color c) {
        ...
        //g.drawLine(this.setXPixel(v[0][7]),this.setYPixel(v[1][7]),this.setXPixel(v[0][0]),this.setYPixel(v[1][0]));  
