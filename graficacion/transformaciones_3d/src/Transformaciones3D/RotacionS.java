...
public class RotacionS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rotación en Y", " " }));
        ...
        jLabel4.setText("ROTACIÓN: SUCESIVA");
 ...
 p[0] = "P1'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RotacionS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
