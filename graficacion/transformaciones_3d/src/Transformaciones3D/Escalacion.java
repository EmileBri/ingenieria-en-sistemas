...
public class Escalacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ESCALACIÓN: BÁSICA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Escalacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Escalacion().setVisible(true);
            }
        });
    }
